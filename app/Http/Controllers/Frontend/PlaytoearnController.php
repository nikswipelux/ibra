...
class PlaytoearnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.playtoearns.index', compact('playtoearns'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.playtoearns.create');
    }
    ...
    public function store(StorePlaytoearnRequest $request)
    {
        ...
        return redirect()->route('frontend.playtoearns.index');
    }
    ...
    public function edit(Playtoearn $playtoearn)
    {
        ...
        return view('frontend.playtoearns.edit', compact('playtoearn'));
    }
    ...
    public function show(Playtoearn $playtoearn)
    {
        ...
        return view('frontend.playtoearns.show', compact('playtoearn'));
    }
