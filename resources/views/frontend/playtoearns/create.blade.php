    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.playtoearns.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="project_link">{{ trans('cruds.playtoearn.fields.project_link') }}</label>
                            <input class="form-control" type="text" name="project_link" id="project_link" value="{{ old('project_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nft_support" id="nft_support" value="{{ old('nft_support', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="blockchain" id="blockchain" value="{{ old('blockchain', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="discord" id="discord" value="{{ old('discord', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_rank" id="total_rank" value="{{ old('total_rank', '') }}" step="1">
