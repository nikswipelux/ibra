    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cmcs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="market_cap" id="market_cap" value="{{ old('market_cap', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cmc_link" id="cmc_link" value="{{ old('cmc_link', '') }}">
