...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cmcs.update", [$cmc->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.cmc.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $cmc->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $cmc->website) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telegram') ? 'is-invalid' : '' }}" type="text" name="telegram" id="telegram" value="{{ old('telegram', $cmc->telegram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $cmc->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discord') ? 'is-invalid' : '' }}" type="text" name="discord" id="discord" value="{{ old('discord', $cmc->discord) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $cmc->price) }}">
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('market_cap') ? 'is-invalid' : '' }}" type="text" name="market_cap" id="market_cap" value="{{ old('market_cap', $cmc->market_cap) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cmc_link') ? 'is-invalid' : '' }}" type="text" name="cmc_link" id="cmc_link" value="{{ old('cmc_link', $cmc->cmc_link) }}">
