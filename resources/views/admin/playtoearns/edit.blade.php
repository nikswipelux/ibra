...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.playtoearns.update", [$playtoearn->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="project_link">{{ trans('cruds.playtoearn.fields.project_link') }}</label>
                <input class="form-control {{ $errors->has('project_link') ? 'is-invalid' : '' }}" type="text" name="project_link" id="project_link" value="{{ old('project_link', $playtoearn->project_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $playtoearn->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $playtoearn->status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nft_support') ? 'is-invalid' : '' }}" type="text" name="nft_support" id="nft_support" value="{{ old('nft_support', $playtoearn->nft_support) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blockchain') ? 'is-invalid' : '' }}" type="text" name="blockchain" id="blockchain" value="{{ old('blockchain', $playtoearn->blockchain) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $playtoearn->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $playtoearn->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discord') ? 'is-invalid' : '' }}" type="text" name="discord" id="discord" value="{{ old('discord', $playtoearn->discord) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telegram') ? 'is-invalid' : '' }}" type="text" name="telegram" id="telegram" value="{{ old('telegram', $playtoearn->telegram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_rank') ? 'is-invalid' : '' }}" type="number" name="total_rank" id="total_rank" value="{{ old('total_rank', $playtoearn->total_rank) }}" step="1">
